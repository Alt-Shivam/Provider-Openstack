...
dev: $(KIND) $(KUBECTL)
	...
	@$(INFO) Installing Provider Openstack CRDs
	@$(KUBECTL) apply -R -f package/crds
	@$(INFO) Starting Provider Openstack controllers
...
# This target prepares repo for your provider by replacing all "openstack"
